...
export const MOTOR_TEMPLATES: Record<string, MotorTemplate> = {
  ...
  quad_h: {
    ...
    forwardMotors: [],
    vtolMotors: [
      { number: 1, x: 0.6, y: 1.0, rotation: 'CCW', function: 33, defaultOutput: 1 },
      { number: 2, x: -0.6, y: -1.0, rotation: 'CCW', function: 34, defaultOutput: 2 },
      { number: 3, x: 0.6, y: -1.0, rotation: 'CW', function: 35, defaultOutput: 3 },
      { number: 4, x: -0.6, y: 1.0, rotation: 'CW', function: 36, defaultOutput: 4 },
    ],
  },
  ...
  octaquad_x: {
    id: 'octaquad_x',
    name: 'OctaQuad X',
    description: 'OctaQuad X (4 arms, coaxial pairs)',
    frameClass: 4,
    frameType: 1,
    forwardMotors: [],
    vtolMotors: [
      ...
      { number: 6, x: -0.7, y: -0.7, rotation: 'CW', function: 38, defaultOutput: 6 },
      { number: 7, x: 0.7, y: -0.7, rotation: 'CCW', function: 39, defaultOutput: 7 },
      { number: 8, x: -0.7, y: 0.7, rotation: 'CCW', function: 40, defaultOutput: 8 },
    ],
  },
  ...
  octaquad_h: {
    id: 'octaquad_h',
    name: 'OctaQuad H',
    description: 'OctaQuad H-frame (4 arms, coaxial pairs)',
    frameClass: 4,
    frameType: 3,
    forwardMotors: [],
    vtolMotors: [
      ...
      { number: 3, x: 0.6, y: -1.0, rotation: 'CW', function: 35, defaultOutput: 3 },
      { number: 4, x: -0.6, y: 1.0, rotation: 'CW', function: 36, defaultOutput: 4 },
      { number: 5, x: 0.6, y: 1.0, rotation: 'CW', function: 37, defaultOutput: 5 },
      { number: 6, x: -0.6, y: -1.0, rotation: 'CW', function: 38, defaultOutput: 6 },
      { number: 7, x: 0.6, y: -1.0, rotation: 'CCW', function: 39, defaultOutput: 7 },
      { number: 8, x: -0.6, y: 1.0, rotation: 'CCW', function: 40, defaultOutput: 8 },
    ],
  },
...
export const AIRFRAME_PRESETS: AirframePreset[] = [
  ...
  {
    id: 'copter_octaquad_x',
    name: 'OctaQuad X',
    description: 'OctaQuad -- 4 arms, 8 coaxial motors, X layout',
    category: 'copter',
    icon: 'octaquad_x',
    planeTemplate: null,
    motorTemplate: MOTOR_TEMPLATES.octaquad_x,
    availableExtras: ['parachute', 'gripper', 'gimbal_pan_tilt'],
    additionalParams: { FRAME_CLASS: 4, FRAME_TYPE: 1 },
  },
  {
    id: 'copter_octaquad_h',
    name: 'OctaQuad H',
    description: 'OctaQuad -- 4 arms, 8 coaxial motors, H-frame',
    category: 'copter',
    icon: 'octaquad_h',
    planeTemplate: null,
    motorTemplate: MOTOR_TEMPLATES.octaquad_h,
    availableExtras: ['parachute', 'gripper', 'gimbal_pan_tilt'],
    additionalParams: { FRAME_CLASS: 4, FRAME_TYPE: 3 },
  },
  {
    id: 'copter_y6',
    name: 'Y6',
